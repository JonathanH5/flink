...
class NormalNaiveBayesITSuite extends FlatSpec with Matchers with FlinkTestBase {
  ...
  it should "train a NaiveBayesClassifier" in {
    ...
    model.transform(env.fromElements("christian moral articl eastman dp nasa kodak write articl vice ico tek bobb vice ico tek robert beauchain write not believ god not concern disposit beneath provid evid requir evid that person thi god find compel fact god you you for minut you love you you made love you want love you don expect love don even exist secondli wouldn expect love simpli creator expect earn that love respons you love god and step promis for you you for you daft love don exist come back you learn love your testicl doubt thi disput not givin sincer effort simpl logic argument folli you read bibl you will that jesu made fool trick logic abil reason spec creation ultim you reli simpli your reason you will never you learn you accept that you don point you step line and becom complet asshol even your offens won slip becuas heard goddamn time you love jesu deep your heart you cannibalist necrophiliac and qualifi assess your motiv you fortun thing accept evid faith that christian quit fuck arrog will never peac you made that bob beauchain bobb vice ico tek that queen stai blew bronx and sank manhattan sea"))
